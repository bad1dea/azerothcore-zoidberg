...
| Dense camps/caves, ranged pulls, pets, full bags, broader guide validation, more race/class combos, explicit pull state machine (per `HONORBUDDY_SINGULAR_COMBAT_RESEARCH.md`) | Not yet attempted | Deferred, `HANDOFF.md` `NEXT TASK` |
