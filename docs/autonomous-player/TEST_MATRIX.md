...
| Dense camps/caves, ranged pulls, pets, full bags, broader guide validation, more race/class combos, `EncounterModel` + structured pull diagnostics (research doc step 2) | Not yet attempted | Deferred, `HANDOFF.md` `NEXT TASK` |
