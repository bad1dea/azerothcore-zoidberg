...
| Dense camps/caves, ranged pulls, pets, full bags, broader guide validation, more race/class combos, class controllers (research doc step 3) | Not yet attempted | Deferred, `HANDOFF.md` `NEXT TASK` |
