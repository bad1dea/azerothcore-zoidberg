...
BUILD_HOST_PATH="${IDLEBOT_BUILD_HOST_PATH:-~/build/azerothcore-zoidberg}"
...
COMPOSE_FILE="${IDLEBOT_COMPOSE_FILE:-~/homelab/compose/zoidberg/compose.yml}"
ENV_SHARED="${IDLEBOT_ENV_SHARED:-~/secrets/shared.env}"
ENV_HOST="${IDLEBOT_ENV_HOST:-~/secrets/zoidberg.env}"
